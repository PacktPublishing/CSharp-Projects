...
public class AttackTargetBehavior(SpaceGame game) : IBehavior
{
    ...
    public bool CanExecute(SpaceEntityBase ship, GameTime time)
    {
        ...
        if (ship.Target is null) return false;
        ...
        Vector2 toTarget = ship.Transform.Position - ship.Target.Transform.Position;
        ...
        float relativeAngle = MathHelper.WrapAngle(angleToTarget - ship.Transform.Rotation);
    ...
    public void Execute(SpaceEntityBase ship, GameTime time)
    {
        ...
        game.SpawnMissile(ship.Transform, ship.Target);
    }
}